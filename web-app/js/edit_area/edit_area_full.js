function EAL(){
    ...
    if(t.isIE>=6||t.isOpera>=9||t.isFirefox||t.isChrome||t.isCamino||t.isSafari>=3)t.isValidBrowser=true;
...
set_browser_infos:function(o){
    ...
    if(o.isIceweasel=(ua.indexOf('Iceweasel')!=-1))o.isFirefox=o.isIceweasel=ua.replace(/^.*?Iceweasel.*?([0-9\.]+).*$/i,"$1");
    if(o.GranParadiso=(ua.indexOf('GranParadiso')!=-1))o.isFirefox=o.isGranParadiso=ua.replace(/^.*?GranParadiso.*?([0-9\.]+).*$/i,"$1");
    if(o.BonEcho=(ua.indexOf('BonEcho')!=-1))o.isFirefox=o.isBonEcho=ua.replace(/^.*?BonEcho.*?([0-9\.]+).*$/i,"$1");
