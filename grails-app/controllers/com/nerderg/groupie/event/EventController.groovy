...
class EventController {
    ...
    def save = {
        params.startDate = params.datestartDate + " " + params.timestartDate
        params.endDate = params.dateendDate + " " + params.timeendDate
        log.debug "dates are $params.startDate to $params.endDate"
