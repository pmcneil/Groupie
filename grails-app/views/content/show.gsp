      ...
      <div class="dialog">
        <table>
          <tbody>
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value">
                <g:link controller="user" action="show" id="${contentInstance?.author?.id}">${contentInstance?.author?.toString().encodeAsHTML()}</g:link>
              </td>
          ...
          <tr class="prop">
            ...
            <td valign="top" class="value"><groupie:displayContent content="${contentInstance}"/></td>
          ...
          <tr class="prop">
            ...
            <td valign="top" class="value"><g:link controller="item" action="show" id="${contentInstance?.item?.id}">${contentInstance?.item?.name.encodeAsHTML()}</g:link></td>
          ...
          <tr class="prop">
            ...
            <td valign="top" class="value">${fieldValue(bean:contentInstance, field:'mimeType')}</td>
