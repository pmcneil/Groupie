        ...
        <table>
          <tbody>
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value">${fieldValue(bean:dataTagInstance, field:'id')}</td>
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value">${fieldValue(bean:dataTagInstance, field:'description')}</td>
