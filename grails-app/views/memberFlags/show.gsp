        ...
        <table>
          <tbody>
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value">${fieldValue(bean:memberFlagsInstance, field:'id')}</td>
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value">${fieldValue(bean:memberFlagsInstance, field:'description')}</td>
            ...
            <tr class="prop">
              ...
              <td valign="top" class="value">${fieldValue(bean:memberFlagsInstance, field:'name')}</td>
